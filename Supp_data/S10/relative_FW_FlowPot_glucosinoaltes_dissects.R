...
cat("\n", file="kw_s10_c.txt", sep="\n", append=TRUE)
write.table(ldply(OT), file="kw_s10_c.txt", col.names=TRUE, row.names=FALSE, append=TRUE)
...
write.table(ldply(KW_output), file="kw_s10_c.txt", col.names=TRUE, row.names=TRUE, append=TRUE)
