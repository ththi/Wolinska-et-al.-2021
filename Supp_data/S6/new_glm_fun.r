...
bc_nam <- read.table("fun_design_fw.txt", header=T)

otu_tab <- read.table("../../Main_datafig2/fun_data/fun_count_tab_rem.txt", header=T)
...
dev.new(height=6.497737,width=4.262443)
...
dev.print(pdf,"fig_S6_b.pdf",useDingbats=F)