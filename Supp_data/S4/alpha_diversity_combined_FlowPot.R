...
p_gen_shannon
ggsave(paste(figures.dir, "fig_S4_x.pdf", sep=""), p_gen_shannon)
...
cat("\n", file="kw_S4_x.txt", sep="\n", append=TRUE)
write.table(ldply(OT), file="kw_S4_x.txt", col.names=TRUE, row.names=FALSE, append=TRUE)
...
write.table(ldply(KW_output), file="kw_S4_x.txt", col.names=TRUE, row.names=TRUE, append=TRUE)
