...
cat("\n", file="KW_s7_f.txt", sep="\n", append=TRUE)
write.table(ldply(OT), file="KW_s7_f.txt", col.names=TRUE, row.names=FALSE, append=TRUE)
...
write.table(ldply(KW_output), file="KW_s7_f.txt", col.names=TRUE, row.names=TRUE, append=TRUE)
